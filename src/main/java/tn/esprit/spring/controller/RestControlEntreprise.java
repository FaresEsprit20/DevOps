...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody EntrepriseDTO ssiiConsultingDto) {
		ientrepriseservice.ajouterEntreprise(ssiiConsultingDto);
		return ssiiConsultingDto.getId();
	}
